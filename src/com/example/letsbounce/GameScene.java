...
public class GameScene extends Scene {
	...
	public void initialize() {
		...
		lvlHealth = 0;
		scoreLabel = new Label(this, 10 / game.density + 60, game.SCREEN_HEIGHT / game.density - 5, "Score: " + score, 100.0f, false);
		livesLabel = new Label(this, 10 / game.density + 60, game.SCREEN_HEIGHT / game.density - 40, "Lives: " + lives, 100.0f, false);
		livesLabel.r = 255;
		livesLabel.g = 50;
		livesLabel.b = 50;
	...
	public void process() {
		...
		if(lives <= 0) {
			if(!gameOver) {
				entities.add(new Label(this, game.SCREEN_WIDTH / 2 / game.density, 100, "Game Over", 200.0f, true));
				...
				entities.add(new Label(this, game.SCREEN_WIDTH / 2 / game.density, 185, "Highscore: " + highScore, 100.0f, true));
			}
			gameOver = true;
		}		
	}
