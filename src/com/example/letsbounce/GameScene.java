...
public class GameScene extends Scene {
	...
	public void initialize() {
		...
		lvlHealth = 0;
		scoreLabel = new Label(this, 10 / game.density + 60, game.SCREEN_HEIGHT / game.density - 5, "Score: " + score, R.dimen.fontsize_normal, false);
		livesLabel = new Label(this, 10 / game.density + 60, game.SCREEN_HEIGHT / game.density - 40, "Lives: " + lives, R.dimen.fontsize_normal, false);
		livesLabel.r = 255;
		livesLabel.g = 50;
		livesLabel.b = 50;
	...
	public void process() {
		...
		if(lives <= 0) {
			if(!gameOver) {
				entities.add(new Label(this, game.SCREEN_WIDTH / 2 / game.density, 100, "Game Over", R.dimen.fontsize_gameover, true));
				...
				entities.add(new Label(this, game.SCREEN_WIDTH / 2 / game.density, 185, "Highscore: " + highScore, R.dimen.fontsize_normal, true));
			}
			gameOver = true;
		}		
	}
